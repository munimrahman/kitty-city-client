...
const ProductDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://kitty-city-server.vercel.app/products/${productId}`)
      .then((res) => res.json())
      ...
      <div className="py-5">
        <div className="container row mx-auto">
          ...
          <div className="col-12 col-md-6">
            ...
            <p className="fw-bold fs-3 primary-text">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-6">
                <Link to="/cart">
                  <button
                    className="btn btn-danger text-white fw-bold py-2 w-100 rounded-pill shadow-none"
            ...
            <p className="py-3 text-secondary service-font-size">
              ...
              <span className="primary-text">Cat</span>,{" "}
              <span className="primary-text">Bed</span>
            </p>
          </div>
        </div>
      </div>

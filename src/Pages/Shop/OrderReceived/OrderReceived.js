...
const OrderReceived = () => {
    ...
    const { _id, name, address, city, email, country, phone, zip, orderStatus, orderDate, item } = orderData || {};
    const items = item?.cartProducts;
    useEffect(() => {
    ...
    return (
        <div className="bg-eee py-4">
            <div className="container rounded bg-white shadow py-4 px-4">
                ...
                {orderStatus === "CONFIRMED" ? <p>Welcome! Your Order is &nbsp;<span className="badge bg-success">CONFIRMED</span>!</p> : <p>Thank you. Your Order is &nbsp;<span className="badge bg-warning">PENDING</span>. Please Wait for Confirmation!</p>}
